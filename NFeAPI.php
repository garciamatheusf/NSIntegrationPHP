...
class NFeAPI extends NSAPICommons{
	private $urlEnvioNFe;
	...
	public function downloadNFe($chNFe, $tpAmb = "2", $tpDown, $printCEAN=false, $obsCanhoto=false){
		$conteudo['chNFe'] = $chNFe;
		$conteudo['tpAmb'] = $tpAmb;
		$conteudo['tpDown'] = $tpDown;
		$conteudo['printCEAN'] = $printCEAN;
		$conteudo['obsCanhoto'] = $obsCanhoto;
	...
	public function downloadEventoNFe($chNFe, $tpDown, $tpEvento, $nSeqEvento="1"){
		$conteudo['chNFe'] = $chNFe;
		$conteudo['tpDown'] = $tpDown;
	...
	public function consultaSituacaoNFe($chNFe, $tpAmb, $licencaCnpj, $versao="4.00"){
		$conteudo['chNFe'] = $chNFe;
		$conteudo['tpAmb'] = $tpAmb;
